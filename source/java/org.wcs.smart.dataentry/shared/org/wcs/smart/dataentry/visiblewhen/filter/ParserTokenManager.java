...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 168 - (jjnewStateCnt = startsAt)))
         break;
      try { curChar = input_stream.readChar(); }
...
static final int[] jjnextStates = {
   39, 40, 41, 34, 35, 36, 24, 159, 20, 22, 33, 38, 45, 47, 15, 16, 
   18, 26, 28, 29, 30, 31, 34, 35, 36, 24, 35, 36, 24, 39, 40, 41, 
   49, 50, 52, 66, 79, 92, 105, 118, 131, 144, 157, 25, 26, 28, 
};
...
static final long[] jjtoMore = {
   0x0L, 
    ...
    private final int[] jjrounds = new int[168];
    private final int[] jjstateSet = new int[2 * 168];
