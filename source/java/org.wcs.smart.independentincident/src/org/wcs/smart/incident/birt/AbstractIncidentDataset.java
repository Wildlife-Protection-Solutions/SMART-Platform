...
public abstract class AbstractIncidentDataset implements IQuery{
	...
	protected UUID incidentUuid;

	protected IResultSetMetaData r_metadata = null;
	protected int m_maxRows;
	protected IncidentDatasetParameterMetadata p_metadata;
	
	public AbstractIncidentDataset(SmartIncidentConnection connection, String datasetType) {
	...
	protected abstract IResultSetMetaData createMetadata();
	
	@Override
	public IResultSetMetaData getMetaData() throws OdaException {
		if (r_metadata == null){
			r_metadata = createMetadata();
		}
		return r_metadata;
	}

	@Override
	public abstract IResultSet executeQuery() throws OdaException ;
...
//		return set;
	...
	public void setObject(String parameterName, Object value)
		...
		for (int i = 1; i <= getParameterMetaData().getParameterCount(); i ++){
			if (p_metadata.getParameterName(i).equals(parameterName)){
				setObject(i, value);
				break;
			}
		}
	...
	public void setObject(int parameterId, Object value) throws OdaException {
		if (getParameterMetaData().getParameterName(parameterId).equalsIgnoreCase(IncidentDatasetParameterMetadata.UUID_PARAM_NAME)) {
			if (value instanceof UUID) {
				incidentUuid = (UUID)value;
	...
	public IParameterMetaData getParameterMetaData() throws OdaException {
		if (p_metadata == null) {
			p_metadata = new IncidentDatasetParameterMetadata(datasetType);
		}
		return p_metadata;
	}
