 ...
 *
 */
package org.wcs.smart.udig.catalog.image.auxxml;
 ...
 * 
 */
public class AuxMdImagePlugin extends AbstractUIPlugin {
    
    public static final String PROTOCOL_FILE = "file"; //$NON-NLS-1$
    
    private static AuxMdImagePlugin plugin;
     ...
     */
    public static AuxMdImagePlugin getDefault() {
        return plugin;
    }
    ...
    public static String getResourceString(String key) {
        ResourceBundle bundle = AuxMdImagePlugin.getDefault().getResourceBundle();
        try {
        ...
        try {
            if(this.resourceBundle == null) {
                this.resourceBundle = ResourceBundle.getBundle(
                        "org.wcs.smart.catalog.worldimage.WorldImagePluginResources"); //$NON-NLS-1$
            }
        } catch(MissingResourceException ex) {
            this.resourceBundle = null;
        }
