...
public class CommunityWaypointSourceProvider implements IWaypointSourceUiProvider {

	public CommunityWaypointSourceProvider() {
	}
	...
	public void findAndShow(UUID waypointUuid) {
		...
		try(Session s = HibernateManager.openSession()){
			...
			if (pw == null){
				MessageDialog.openError(Display.getDefault().getActiveShell(), ERROR_STR, "Community waypoint not found.");
				return;
			}
		}
		...
		ctx.set(OpenIncidentHandler.SOURCE_PARAM, CommunityWaypointSource.KEY);
