...
private int jjMoveStringLiteralDfa0_0(){
   switch(curChar)
   {
      ...
      case 97:
         return jjMoveStringLiteralDfa1_0(0x8000000020000080L, 0x7L);
      case 98:
...
private int jjMoveStringLiteralDfa1_0(long active0, long active1){
   ...
   switch(curChar)
   {
      ...
      case 115:
         return jjMoveStringLiteralDfa2_0(active0, 0x8000000000000000L, active1, 0x7L);
      case 120:
         return jjMoveStringLiteralDfa2_0(active0, 0x400L, active1, 0L);
      default :
         break;
...
private int jjMoveStringLiteralDfa2_0(long old0, long active0, long old1, long active1){
   ...
   switch(curChar)
   {
      ...
      case 115:
         return jjMoveStringLiteralDfa3_0(active0, 0x8000000000000000L, active1, 0x27L);
      case 116:
         if ((active0 & 0x100L) != 0L)
         {
            jjmatchedKind = 8;
...
private int jjMoveStringLiteralDfa3_0(long old0, long active0, long old1, long active1){
   ...
   switch(curChar)
   {
      ...
      case 101:
         return jjMoveStringLiteralDfa4_0(active0, 0x8000000000000000L, active1, 0x27L);
      case 105:
...
private int jjMoveStringLiteralDfa4_0(long old0, long active0, long old1, long active1){
   ...
   switch(curChar)
   {
      ...
      case 111:
         return jjMoveStringLiteralDfa5_0(active0, 0x2000000L, active1, 0x40L);
      case 114:
      ...
      case 116:
         ...
         return jjMoveStringLiteralDfa5_0(active0, 0x8000000000000000L, active1, 0x7L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa5_0(long old0, long active0, long old1, long active1){
   ...
   {
      case 58:
         return jjMoveStringLiteralDfa6_0(active0, 0x8000000000000000L, active1, 0x7L);
      case 101:
         return jjMoveStringLiteralDfa6_0(active0, 0x48000000L, active1, 0L);
      case 105:
         return jjMoveStringLiteralDfa6_0(active0, 0x1000000L, active1, 0x40L);
      case 110:
...
private int jjMoveStringLiteralDfa6_0(long old0, long active0, long old1, long active1){
   ...
   {
      case 97:
         return jjMoveStringLiteralDfa7_0(active0, 0x8000000000000000L, active1, 0x22L);
      case 108:
      ...
      case 110:
         ...
         return jjMoveStringLiteralDfa7_0(active0, 0x1000000L, active1, 0x40L);
      case 115:
...
private int jjMoveStringLiteralDfa7_0(long old0, long active0, long old1, long active1){
   ...
   switch(curChar)
   {
      ...
      case 115:
         ...
         return jjMoveStringLiteralDfa8_0(active0, 0x8000000000000000L, active1, 0x2L);
      case 116:
         if ((active1 & 0x40L) != 0L)
         {
            jjmatchedKind = 70;
...
private int jjMoveStringLiteralDfa8_0(long old0, long active0, long old1, long active1){
   ...
   switch(curChar)
   {
      ...
      case 105:
         return jjMoveStringLiteralDfa9_0(active0, 0x2000000L, active1, 0x20L);
      case 114:
...
private int jjMoveStringLiteralDfa9_0(long old0, long active0, long old1, long active1){
   ...
   switch(curChar)
   {
      ...
      case 101:
         return jjMoveStringLiteralDfa10_0(active0, 0x8000000000000000L, active1, 0x2L);
      case 110:
...
private int jjMoveStringLiteralDfa10_0(long old0, long active0, long old1, long active1){
   ...
   switch(curChar)
   {
      ...
      case 116:
         ...
         return jjMoveStringLiteralDfa11_0(active0, 0L, active1, 0x6L);
      default :
         break;
   }
...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 560:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjCheckNAddTwoStates(560, 534); }
                  break;
               case 561:
                  if (curChar == 46)
                     { jjCheckNAddTwoStates(533, 541); }
                  break;
               case 562:
                  if ((0x3ff000000000000L & l) != 0L)
               ...
               case 669:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjCheckNAddTwoStates(669, 643); }
                  break;
               case 670:
                  if (curChar == 46)
                     { jjCheckNAddTwoStates(642, 650); }
                  break;
               case 671:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjCheckNAddStates(182, 189); }
                  break;
               case 673:
                  if (curChar == 58)
               ...
               case 1180:
                  ...
                  if (kind > 84)
                     kind = 84;
                  { jjCheckNAddTwoStates(1181, 1183); }
                  break;
               case 1182:
                  if ((0x3ff400000000000L & l) == 0L)
                     break;
               ...
               case 1185:
                  ...
                  if (kind > 84)
                     kind = 84;
                  { jjCheckNAddTwoStates(1183, 1185); }
                  break;
               case 1211:
                  if (curChar == 58)
               ...
               case 1214:
                  ...
                  if (kind > 85)
                     kind = 85;
                  { jjCheckNAddTwoStates(1215, 1217); }
                  break;
               case 1216:
                  if ((0x3ff400000000000L & l) == 0L)
                     break;
               ...
               case 1219:
                  ...
                  if (kind > 85)
                     kind = 85;
                  { jjCheckNAddTwoStates(1217, 1219); }
                  break;
               case 1221:
                  if (curChar == 58)
               ...
               case 1233:
                  ...
                  if (kind > 85)
                     kind = 85;
                  { jjCheckNAddTwoStates(1234, 1236); }
                  break;
               case 1235:
                  if ((0x3ff400000000000L & l) == 0L)
                     break;
               ...
               case 1238:
                  ...
                  if (kind > 85)
                     kind = 85;
                  { jjCheckNAddTwoStates(1236, 1238); }
                  break;
               case 1240:
                  if (curChar == 58)
               ...
               case 1267:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1267, 1256); }
                  break;
               case 1268:
                  if ((0x3ff000000000000L & l) != 0L)
               ...
               case 1269:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1269, 1256); }
                  break;
               case 1270:
                  if ((0x3ff000000000000L & l) != 0L)
               ...
               case 1272:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1272, 1256); }
                  break;
               case 1273:
                  if ((0x3ff000000000000L & l) != 0L)
               ...
               case 1279:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1279, 1256); }
                  break;
               case 1280:
                  if ((0x3ff000000000000L & l) != 0L)
               ...
               case 1282:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjCheckNAddTwoStates(1282, 1256); }
                  break;
               case 1283:
                  if (curChar == 46)
                     { jjCheckNAddTwoStates(1255, 1263); }
                  break;
               case 1284:
                  if ((0x3ff000000000000L & l) != 0L)
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 1305 - (jjnewStateCnt = startsAt)))
         break;
      try { curChar = input_stream.readChar(); }
...
null, null, null, null, null, null, null, null, null, null, null, null, null, null, 
null, null, "\141\163\163\145\164\72\141\163\163\145\164", 
...
static final int[] jjnextStates = {
   123, 124, 125, 118, 119, 120, 108, 1296, 104, 106, 117, 122, 129, 131, 82, 83, 
   85, 43, 47, 52, 59, 62, 70, 76, 110, 112, 113, 114, 115, 118, 119, 120, 
   108, 119, 120, 108, 123, 124, 125, 133, 134, 136, 150, 165, 175, 190, 200, 215, 
   225, 240, 250, 265, 275, 290, 300, 315, 325, 340, 359, 361, 375, 376, 383, 391, 
   392, 404, 429, 430, 453, 461, 462, 474, 437, 438, 442, 451, 497, 498, 507, 509, 
   531, 561, 562, 532, 540, 551, 556, 541, 542, 534, 544, 546, 547, 548, 549, 534, 
