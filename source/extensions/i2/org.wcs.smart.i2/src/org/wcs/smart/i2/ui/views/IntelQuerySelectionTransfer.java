...
public class IntelQuerySelectionTransfer extends ByteArrayTransfer {
    ...
    private static final String TYPE_NAME = "intel-query-selection-transfer-format" + (Long.valueOf(System.currentTimeMillis())).toString(); //$NON-NLS-1$;

    private static final int TYPEID = registerType(TYPE_NAME);

    private static final IntelQuerySelectionTransfer INSTANCE = new IntelQuerySelectionTransfer();
     ...
     */
    protected IntelQuerySelectionTransfer() {
    	// do nothing
    }
     ...
     */
    public static IntelQuerySelectionTransfer getTransfer() {
        return INSTANCE;
    }
