...
public class ShowProfileSettingsHandler { 
	...
	public void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell activeShell, IEclipseContext context) {
		...
		manager.addToRoot(new SmartPreferenceNode("org.wcs.smart.i2.pref.entitytypes",  //$NON-NLS-1$
		...
		manager.addToRoot(new PreferenceNode("org.wcs.smart.i2.pref.relgroups",  //$NON-NLS-1$
				ContextInjectionFactory.make(RelationshipGroupsPreferencePage.class, context)));

		manager.addToRoot(new SmartPreferenceNode("org.wcs.smart.i2.pref.relations", //$NON-NLS-1$
		...
		manager.addToRoot(new SmartPreferenceNode("org.wcs.smart.i2.pref.records", //$NON-NLS-1$
		...
		manager.addToRoot(new SmartPreferenceNode("org.wcs.smart.i2.pref.settings", //$NON-NLS-1$
		...
		manager.addToRoot(new SmartPreferenceNode("org.wcs.smart.i2.pref.styles", //$NON-NLS-1$
