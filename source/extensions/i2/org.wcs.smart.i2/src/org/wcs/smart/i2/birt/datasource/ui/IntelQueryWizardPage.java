...
public class IntelQueryWizardPage extends DataSetWizardPage {
	 ...
	 * @param pageName
	 */
	public IntelQueryWizardPage(String pageName) {
		super(pageName);
		setTitle(pageName);
		setMessage(message);
	}
	 ...
	 * @param titleImage
	 */
	public IntelQueryWizardPage(String pageName, String title,
	...
	private void initializeControl() {
		...
		if (queryText != null && !queryText.isEmpty()){
			...
			if (selection != null) lstQueries.setSelection(new StructuredSelection(selection));
		}
		validateData();
		setMessage(message);
	}
	...
	protected String getDatasetType() {
		return IntelQueryDataset.DATASET_TYPE;
	}
