...
public class IntelEntitySelectionTransfer extends ByteArrayTransfer {

    // First attempt to create a UUID for the type name to make sure that
    // different Eclipse applications use different "types" of
    // <code>IntelEntitySelectionTransfer</code>
    private static final String TYPE_NAME = "intel-entity-selection-transfer-format" + (Long.valueOf(System.currentTimeMillis())).toString(); //$NON-NLS-1$;

    private static final int TYPEID = registerType(TYPE_NAME);

    private static final IntelEntitySelectionTransfer INSTANCE = new IntelEntitySelectionTransfer();
     ...
     */
    protected IntelEntitySelectionTransfer() {
    	// do nothing
    }
     ...
     */
    public static IntelEntitySelectionTransfer getTransfer() {
        return INSTANCE;
    }
