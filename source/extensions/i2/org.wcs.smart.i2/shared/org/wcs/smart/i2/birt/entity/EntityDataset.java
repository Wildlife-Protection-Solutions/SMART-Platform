...
public class EntityDataset  implements IQuery {
	...
	public IResultSet executeQuery() throws OdaException {
		EntityDatasetResultSet set = new EntityDatasetResultSet(type, (EntityDatasetResultSetMetadata)getMetaData(), connection, parameters);
		return set;
	}
	...
	public void setObject(String parameterName, Object value)
			throws OdaException {
		for(EntityParameterMetadata.EntityParameter p : EntityParameterMetadata.EntityParameter.values()){
			if (p.name.equals(parameterName)){
				setObject(p.index, value);
				return;
			}
		}
	}
