...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 379 - (jjnewStateCnt = startsAt)))
         break;
      try { curChar = input_stream.readChar(); }
...
static final int[] jjnextStates = {
   39, 40, 41, 34, 35, 36, 24, 370, 20, 22, 33, 38, 45, 47, 15, 16, 
   18, 26, 28, 29, 30, 31, 34, 35, 36, 24, 35, 36, 24, 39, 40, 41, 
   49, 50, 52, 66, 81, 91, 106, 116, 131, 141, 156, 166, 181, 191, 206, 216, 
   231, 241, 256, 277, 290, 303, 316, 329, 342, 355, 368, 63, 88, 113, 138, 163, 
   188, 213, 238, 263, 25, 26, 28, 65, 66, 81, 90, 91, 106, 115, 116, 131, 
   140, 141, 156, 165, 166, 181, 190, 191, 206, 215, 216, 231, 240, 241, 256, 
};
...
static final long[] jjtoMore = {
   0x0L, 
    ...
    private final int[] jjrounds = new int[379];
    private final int[] jjstateSet = new int[2 * 379];
