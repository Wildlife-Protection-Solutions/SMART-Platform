...
public class Parser implements ParserConstants {
  ...
  final public IFilter EventFilter() throws ParseException {IFilter expr;
    expr = ExpressionPart();
    jj_consume_token(0);
{if ("" != null) return expr;}
...
{if ("" != null) return AttributeFilter.GeometryProperty.valueOfKey(token.image);}
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x280,0x100,0x80000,0x0,0x0,0x0,0x680,0x680,0x0,0x0,0x0,0x0,0x7f000,0x7000000,0x8000100,0x280,0x800,0x60000000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x0,0x7ffff0,0x10080,0x402000,0x8040,0x0,0x0,0x7fffe0,0x100800,0x201000,0x4020,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
