package org.wcs.smart.event.i2.internal;

import org.eclipse.osgi.util.NLS;

public class Messages extends NLS {
	private static final String BUNDLE_NAME = "org.wcs.smart.event.i2.internal.messages"; //$NON-NLS-1$
	public static String AdvIntelLabelProvider_CreateActionTypeDesc;
	public static String AdvIntelLabelProvider_CreateActionTypeMsg1;
	public static String AdvIntelLabelProvider_CreateActionTypeMsg2;
	public static String AdvIntelLabelProvider_CreateActionTypeMsg3;
	public static String AdvIntelLabelProvider_CreateActionTypeMsg4;
	public static String AdvIntelLabelProvider_CreateActionTypeMsg5;
	public static String AdvIntelLabelProvider_CreateActionTypeName;
	public static String AdvIntelLabelProvider_SourceParameterName;
	public static String AdvIntelLabelProvider_TitleParameterName;
	...
	public static String NewMappingDialog_DmAttributeLabel;
	public static String NewMappingDialog_DmListItem;
	public static String NewMappingDialog_FixedLabel;
	public static String NewMappingDialog_IListItems;
	public static String NewMappingDialog_MapToLabel;
