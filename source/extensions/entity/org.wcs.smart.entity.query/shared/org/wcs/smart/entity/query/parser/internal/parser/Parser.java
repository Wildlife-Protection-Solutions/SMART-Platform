...
/* ------------ Expressions ----------------------*/
  ...
  final public IGroupBy GroupByItem() throws ParseException {
    ...
    case CATEGORY_ATTRIBUTE_GROUPBY_ITEM:
      ...
      break;
    case CA_GROUPBY_ITEM:
      jj_consume_token(CA_GROUPBY_ITEM);
  ...
  final public IFilter AttributeExpression() throws ParseException {
    ...
    case EA_ATT_LIST_KEY:
      ...
      break;
    case ET_ATT_LIST_KEY:
      jj_consume_token(ET_ATT_LIST_KEY);
                                     key = token.image;
      jj_consume_token(EQUAL);
                            op = Operator.parseOperator(token.image);
      jj_consume_token(DM_KEY);
                             value = token.image;
                filter = EntityTypeFilter.createListItemFilter(key,op,value);
      break;
    case ATT_TREE_KEY:
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80100,0x80100,0x0,0x80100,0x0,0x0,0x800,0x0,0x0,0x800,0x0,0x280,0x100,0x80000,0x0,0x0,0x680,0x680,0x0,0x0,0x0,0x7f000,0x7000000,0x280,0x8000100,0x800,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xfe21fffe,0xfe21fffe,0x0,0xfe21fffe,0x10000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xfe20fffe,0x80000810,0x4000408,0x0,0x0,0xfe00fffc,0x40008100,0x2000204,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x1,0x1,0x100,0x1,0x0,0x3e,0x0,0x3e,0xfe80,0x0,0xfe80,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x1,0x0,0x1,0x0,0x0,0x0,0x0,0x0,};
   }
