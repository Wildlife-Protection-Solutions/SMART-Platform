...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 803:
                  if ((0x3ff000000000000L & l) != 0L)
                     jjCheckNAddTwoStates(803, 777);
                  break;
               case 804:
                  if (curChar == 46)
                     jjCheckNAddTwoStates(776, 784);
                  break;
               case 805:
                  if ((0x3ff000000000000L & l) != 0L)
               ...
               case 1147:
                  ...
                  if (kind > 87)
                     kind = 87;
                  jjCheckNAddTwoStates(1148, 1150);
                  break;
               case 1149:
                  if ((0x3ff400000000000L & l) == 0L)
                     break;
               ...
               case 1152:
                  ...
                  if (kind > 87)
                     kind = 87;
                  jjCheckNAddTwoStates(1150, 1152);
                  break;
               case 1154:
                  if (curChar == 58)
               ...
               case 1176:
                  ...
                  if (kind > 88)
                     kind = 88;
                  jjCheckNAddTwoStates(1177, 1179);
                  break;
               case 1178:
                  if ((0x3ff400000000000L & l) == 0L)
                     break;
               ...
               case 1181:
                  ...
                  if (kind > 88)
                     kind = 88;
                  jjCheckNAddTwoStates(1179, 1181);
                  break;
               case 1183:
                  if (curChar == 58)
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 1216 - (jjnewStateCnt = startsAt)))
         break;
      try { curChar = input_stream.readChar(); }
...
static final int[] jjnextStates = {
   108, 109, 110, 103, 104, 105, 93, 817, 89, 91, 102, 107, 114, 116, 79, 80, 
   82, 35, 39, 44, 51, 54, 95, 97, 98, 99, 100, 103, 104, 105, 93, 104, 
   105, 93, 108, 109, 110, 118, 119, 121, 140, 155, 165, 180, 190, 205, 215, 230, 
   240, 259, 269, 288, 298, 313, 323, 338, 352, 354, 368, 369, 376, 379, 380, 405, 
   406, 415, 417, 439, 469, 470, 440, 448, 459, 464, 449, 450, 442, 452, 454, 455, 
   456, 457, 442, 456, 457, 442, 460, 461, 462, 450, 442, 460, 450, 442, 461, 462, 
   450, 442, 463, 450, 442, 465, 466, 467, 442, 466, 467, 442, 465, 466, 467, 460, 
   461, 462, 450, 442, 480, 481, 484, 485, 511, 512, 515, 516, 517, 547, 548, 518, 
   526, 537, 542, 527, 528, 520, 530, 532, 533, 534, 535, 520, 534, 535, 520, 538, 
   539, 540, 528, 520, 538, 528, 520, 539, 540, 528, 520, 541, 528, 520, 543, 544, 
   545, 520, 544, 545, 520, 543, 544, 545, 538, 539, 540, 528, 520, 669, 670, 653, 
   654, 659, 663, 668, 680, 683, 684, 707, 709, 732, 733, 738, 742, 747, 753, 754, 
   772, 773, 774, 804, 805, 775, 783, 794, 799, 784, 785, 777, 787, 789, 790, 791, 
   792, 777, 791, 792, 777, 795, 796, 797, 785, 777, 795, 785, 777, 796, 797, 785, 
   777, 798, 785, 777, 800, 801, 802, 777, 801, 802, 777, 800, 801, 802, 795, 796, 
   797, 785, 777, 964, 969, 993, 996, 1012, 1013, 1016, 1019, 1036, 1037, 1040, 1043, 1060, 
   1061, 1064, 1067, 1087, 1090, 1146, 1147, 1175, 1176, 840, 855, 876, 897, 913, 929, 950, 
   987, 1009, 1033, 1057, 1081, 1108, 1110, 1126, 1143, 1172, 1196, 1215, 580, 593, 606, 619, 
   632, 645, 673, 698, 721, 723, 750, 769, 815, 137, 162, 187, 212, 237, 266, 295, 
   320, 345, 365, 402, 437, 477, 508, 566, 124, 126, 85, 87, 94, 95, 97, 139, 
   140, 155, 164, 165, 180, 189, 190, 205, 214, 215, 230, 239, 240, 259, 242, 243, 
   268, 269, 288, 271, 272, 297, 298, 313, 322, 323, 338, 367, 368, 369, 382, 384, 
   404, 405, 406, 443, 444, 445, 445, 446, 447, 451, 452, 454, 479, 480, 481, 483, 
   484, 485, 486, 487, 488, 488, 489, 490, 510, 511, 512, 514, 515, 516, 521, 522, 
   523, 523, 524, 525, 529, 530, 532, 686, 688, 727, 728, 729, 729, 730, 731, 752, 
   753, 754, 755, 756, 757, 757, 758, 759, 771, 772, 773, 778, 779, 780, 780, 781, 
   782, 786, 787, 789, 1011, 1012, 1013, 1035, 1036, 1037, 1059, 1060, 1061, 1145, 1146, 1147, 
   1148, 1149, 1150, 1150, 1151, 1152, 1174, 1175, 1176, 1177, 1178, 1179, 1179, 1180, 1181, 
};
...
private final int[] jjrounds = new int[1216];
private final int[] jjstateSet = new int[2432];
