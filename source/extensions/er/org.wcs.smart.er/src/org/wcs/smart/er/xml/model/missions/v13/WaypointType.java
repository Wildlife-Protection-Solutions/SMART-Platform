 ...
 *         &lt;element name="attachments" type="{http://www.smartconservationsoftware.org/xml/1.3/mission}AttachmentType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="groups" type="{http://www.smartconservationsoftware.org/xml/1.3/mission}WaypointObservationGroupType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class WaypointType {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WaypointObservationGroupType }
     * 
     * 
     */
    public List<WaypointObservationGroupType> getGroups() {
        if (groups == null) {
            groups = new ArrayList<WaypointObservationGroupType>();
        }
        return this.groups;
    }
