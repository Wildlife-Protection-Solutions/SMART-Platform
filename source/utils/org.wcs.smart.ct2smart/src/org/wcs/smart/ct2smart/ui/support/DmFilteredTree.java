 ...
 * @since 3.2
 */
public class DmFilteredTree extends Composite {
	 ...
	 */
	private static final String CLEAR_ICON = "icons/etool16/clear_co.gif"; //$NON-NLS-1$

	/**
	 * Image descriptor for disabled clear button.
	 */
	private static final String DISABLED_CLEAR_ICON= "icons/dtool16/clear_co.gif"; //$NON-NLS-1$
	 ...
	 * @since 3.5
	 */
	public DmFilteredTree(Composite parent, int treeStyle, DmTreePatternFilter filter, boolean useNewLook) {
	 ...
	 * @since 3.5
	 */
	protected DmFilteredTree(Composite parent, boolean useNewLook) {
		super(parent, SWT.NONE);
		this.parent = parent;
		this.useNewLook = useNewLook;
	}
...
.getImageRegistry().getDescriptor(DISABLED_CLEAR_ICON));
	...
	private void createClearTextNew(Composite parent) {
		...
		// natively
		if ((filterText.getStyle() & SWT.ICON_CANCEL) == 0) {
			final Image inactiveImage= new Image(Display.getCurrent(), new ImageData(DISABLED_CLEAR_ICON));
			final Image activeImage= new Image(Display.getCurrent(), new ImageData(CLEAR_ICON));
	 ...
	 * @return bold font
	 */
	public static Font getBoldFont(Object element, DmFilteredTree tree, DmTreePatternFilter filter) {
