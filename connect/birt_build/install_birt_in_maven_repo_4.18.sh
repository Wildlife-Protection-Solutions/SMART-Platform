...
# unzip ~/Downloads/birt-runtime-4.18.0-202412050604.zip -d /tmp/birt-runtime-4.18.0-202412050604

RUNTIME_PATH="C:/data/SMART/BIRT/birt-runtime-4.18.0-202412050604"
...
<project xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 https://maven.apache.org/xsd/maven-4.0.0.xsd" xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <name>org.eclipse.birt.runtime_4.18.0.jar</name>
...
# Core
deploy "${LIB_PATH}/org.eclipse.core.runtime_3.32.0.v20241003-0436.jar" "${GROUP_ID_BASE}" "org.eclipse.core.runtime" "3.31.0"
...
deploy "${LIB_PATH}/org.eclipse.emf.common_2.40.0.v20240911-1027.jar" "${GROUP_ID_BASE}" "org.eclipse.emf.common" "2.30.0"
deploy "${LIB_PATH}/org.eclipse.emf.ecore.xmi_2.38.0.v20240721-0634.jar" "${GROUP_ID_BASE}" "org.eclipse.emf.ecore.xmi" "2.37.0"
deploy "${LIB_PATH}/org.eclipse.emf.ecore_2.38.0.v20241018-1213.jar" "${GROUP_ID_BASE}" "org.eclipse.emf.ecore" "2.36.0"
deploy "${LIB_PATH}/org.eclipse.equinox.common_3.19.200.v20241004-0654.jar" "${GROUP_ID_BASE}" "org.eclipse.equinox.common" "3.19.0"
deploy "${LIB_PATH}/org.eclipse.equinox.registry_3.12.200.v20241004-0654.jar" "${GROUP_ID_BASE}" "org.eclipse.equinox.registry" "3.12.0"
deploy "${LIB_PATH}/org.eclipse.osgi_3.22.0.v20241030-2121.jar" "${GROUP_ID_BASE}" "org.eclipse.osgi" "3.19.0"
...
#zip --delete ${LIB_PATH}/org.eclipse.birt.runtime_4.18.0-202412050604.jar "META-INF/maven/*"
7z d -r ${LIB_PATH}/org.eclipse.birt.runtime_4.18.0-202412050604.jar "META-INF/maven/*"

mvn deploy:deploy-file -Durl=file://${REPO_LOC}/.m2/repository \
    -DpomFile=/tmp/pom.xml \
    -DrepositoryId=third-party \
    -Dfile=${LIB_PATH}/org.eclipse.birt.runtime_4.18.0-202412050604.jar \
