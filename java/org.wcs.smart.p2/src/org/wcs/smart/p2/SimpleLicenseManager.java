...
public class SimpleLicenseManager extends LicenseManager {
	...
	private Preferences getPreferences() {
		IAgentLocation location = (IAgentLocation) Activator.getDefault().getProvisioningAgent().getService(IAgentLocation.SERVICE_NAME);
		return new ProfileScope(location, profileId).getNode(Activator.PLUGIN_ID);
	}
