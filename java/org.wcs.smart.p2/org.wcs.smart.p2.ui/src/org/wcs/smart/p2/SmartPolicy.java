...
public class SmartPolicy extends Policy {
	...
	public SmartPolicy() {
		...
		setRepositoryPreferencePageName("Available Software Sites");
	...
	public boolean continueWorkingOperation(ProfileChangeOperation operation, Shell shell) {
		...
		MessageDialogWithToggle dialog = MessageDialogWithToggle.openYesNoCancelQuestion(shell, "Question", "The software items you selected may not be valid with your current installation.  Do you want to open the wizard anyway to review the selections?", null, false, prefs, PreferenceConstants.PREF_OPEN_WIZARD_ON_ERROR_PLAN);
