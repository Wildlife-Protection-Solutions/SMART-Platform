...
/* ------------ Expressions ----------------------*/
  ...
  final public IValueItem ValueItem() throws ParseException {
    ...
    case PATROL_VALUE_ITEM:
      ...
      break;
    case CAT_VALUE_KEY:
      jj_consume_token(CAT_VALUE_KEY);
                        item = CategoryValueItem.createItem( token.image );
      break;
    case ATTRIBUTE_VALUE_KEY:
      jj_consume_token(ATTRIBUTE_VALUE_KEY);
                        item = AttributeValueItem.createItem( token.image );
      break;
    default:
      jj_la1[3] = jj_gen;
      jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0xf,0xd0,0x0,0xd0,0xa00,0x0,0xa00,0x0,0x0,0xf,0x0,0x0,0xf,0xf,0xf,0x0,0x0,0x0,};
   }
